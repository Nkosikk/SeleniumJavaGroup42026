...
import utils_Nosipho.TakeScreenshot;
import static utils_Nosipho.Base.driver;
...
public class ExtentReportManager implements ITestListener {
    ...
    public void onTestFailure(ITestResult result){
        ...
        test.addScreenCaptureFromBase64String(TakeScreenshot.getSnapShotBase64(driver),result.getName());
